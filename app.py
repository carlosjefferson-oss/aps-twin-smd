...
# =========================================================
# APS-Twin SMD v1.8.1.7.6.5.4.3.2
  ...
  <div class="hero-grid-html">
    <div class="hero-text-block">
      ...
      <div class="hero-shortcuts-grid">
        <span class="hero-shortcut-link">🏥 UBS</span>
        <span class="hero-shortcut-link">📊 SMD</span>
        <span class="hero-shortcut-link">🤖 ML</span>
        <span class="hero-shortcut-link">🧠 Digital Twin</span>
        <span class="hero-shortcut-link">🔌 API</span>
      </div>
    </div>
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.8.1.7.7.6.6.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
atalho_cols_header = st.columns(5)
for i, (rotulo, destino) in enumerate(ATALHOS_MODULOS.items()):
    with atalho_cols_header[i]:
        if st.button(rotulo, key=f"atalho_header_{i}", use_container_width=True):
...
st.divider()
st.caption(
    "APS-Twin SMD v1.8.1.7.6.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
