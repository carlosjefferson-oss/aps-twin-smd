...
def render_header_principal():
    """
    Cabeçalho institucional em HTML único, sem vazamento de tags na tela.
    """
...
<div class="hero-main">
  <div class="hero-grid-html">
    <div class="hero-text-block">
      ...
      <div class="hero-line-html">18 indicadores • Monitoramento longitudinal • Machine Learning • Sistematicidade • Sistema ciberfísico • API em tempo real • Apoio à decisão</div>
      <div class="hero-badges-html">
        <span class="hero-badge-html">🏥 UBS</span>
        <span class="hero-badge-html">📊 SMD</span>
        <span class="hero-badge-html">🤖 ML</span>
        <span class="hero-badge-html">🧠 Digital Twin</span>
        <span class="hero-badge-html">🔌 API</span>
      </div>
    </div>
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.7.5.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.divider()
st.caption(
    "APS-Twin SMD v1.7.5.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
