...
# =========================================================
# APS-Twin SMD v1.8.7.7.6.5.4.3.2
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.8.7.7.7.6.6.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.divider()
st.caption(
    "APS-Twin SMD v1.8.7.7.6.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
