...
# =========================================================
# APS-Twin SMD v1.7.9.7.6.5.4.3.2
  ...
  <div class="hero-grid-html">
    <div class="hero-text-block">
      ...
      <div class="hero-badges-html">
        <span class="hero-badge-html">Navegação rápida pelos módulos do sistema logo abaixo</span>
      </div>
    </div>
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.7.9.7.7.6.6.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.markdown('<div class="hero-shortcuts-title">Atalhos rápidos</div>', unsafe_allow_html=True)
...
st.divider()
st.caption(
    "APS-Twin SMD v1.7.9.7.6.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
