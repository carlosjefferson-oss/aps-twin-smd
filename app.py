...
# =========================================================
# APS-Twin SMD v1.8.2.7.6.5.4.3.2
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.8.2.7.7.6.6.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.markdown(
    '<div class="nav-module-caption">Selecione o módulo desejado. O item marcado indica exatamente onde você está no APS-Twin SMD.</div>',
    unsafe_allow_html=True
)
...
st.divider()
st.caption(
    "APS-Twin SMD v1.8.2.7.6.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
