...
def render_header_principal():
    """
    Cabeçalho institucional 100% em HTML seguro.
    Evita o problema de texto branco fora do card e HTML aparecendo na tela.
    """
    ...
    if flag_salgueiro_b64:
        salgueiro_html = f"""
        <div class="flag-card">
            <img src="data:image/png;base64,{flag_salgueiro_b64}" class="flag-img" />
            <div class="flag-label">Salgueiro-PE</div>
        </div>
        """
    else:
        salgueiro_html = """
        <div class="flag-card flag-missing">
            <div class="flag-placeholder">Salgueiro-PE</div>
        </div>
        """
    ...
    if flag_pe_b64:
        pe_html = f"""
        <div class="flag-card">
            <img src="data:image/png;base64,{flag_pe_b64}" class="flag-img" />
            <div class="flag-label">Pernambuco</div>
        </div>
        """
    else:
        pe_html = """
        <div class="flag-card flag-missing">
            <div class="flag-placeholder">Pernambuco</div>
        </div>
        """
    ...
    st.markdown(
        ...
        <style>
            .hero-main {{
                ...
                box-sizing: border-box;
                background:
                    radial-gradient(circle at 92% 10%, rgba(255,255,255,0.24), transparent 28%),
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.7.4.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.divider()
st.caption(
    "APS-Twin SMD v1.7.4.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
