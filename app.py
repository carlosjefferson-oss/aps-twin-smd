...
Relatório gerado automaticamente pelo APS-Twin SMD v1.7.1.1.
"""
    return relatorio
...
st.divider()
st.caption(
    "APS-Twin SMD v1.7.1 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
