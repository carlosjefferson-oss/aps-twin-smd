...
# =========================================================
# APS-Twin SMD v1.7.8.7.6.5.4.3.2
...
Relatório gerado automaticamente pelo APS-Twin SMD v1.7.8.7.7.6.6.5.5.4.4.3.3.2.2.1.
"""
    return relatorio
...
st.markdown('<div class="atalho-modulo-label">Atalhos rápidos</div>', unsafe_allow_html=True)
atalho_cols = st.columns(5)
for i, (rotulo, destino) in enumerate(ATALHOS_MODULOS.items()):
    with atalho_cols[i]:
        if st.button(rotulo, key=f"atalho_{i}", use_container_width=True):
...
st.divider()
st.caption(
    "APS-Twin SMD v1.7.8.7.6.5.4.3.2 | Protótipo web em Python | API em tempo real | Qualidade dos Dados | Relatórios Executivos | Digital Twin Ciberfísico-Gerencial da APS | "
